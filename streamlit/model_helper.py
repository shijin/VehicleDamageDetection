...
BASE_DIR = Path(__file__).resolve().parent        # damage-prediction/streamlit
PROJECT_ROOT = BASE_DIR.parent                   # damage-prediction

MODEL_PATH = PROJECT_ROOT / "model" / "saved_model.pth"
